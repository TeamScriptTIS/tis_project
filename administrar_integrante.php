<?php
	...
	if(isset($_SESSION['nombre_usuario']) && $_SESSION['tipo']!=4) {/*SI EL QUE INGRESO A NUESTRA PAGINA ES CONSULTOR DE CUALQUIER TIPO*/
		$home="";
			...
			<?php 
				if($gestion_valida) {
					...
					$consulta_id_ge = mysql_query("SELECT ge.id_grupo_empresa
                               					   ...
                               					   WHERE u.id_usuario='".$_SESSION['id']."' and u.id_usuario=i.usuario and i.grupo_empresa=ge.id_grupo_empresa",$conn) or 
