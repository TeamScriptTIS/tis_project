<?php
  ...
  if(isset($_SESSION['nombre_usuario']) && $_SESSION['tipo']!=1) {/*SI EL QUE INGRESO A NUESTRA PAGINA ES CONSULTOR DE CUALQUIER TIPO*/
    $home="";
	...
	<div class="row-fluid">
        ...
        <?php
            ...
            echo "<div align=\"center\">
                    <h4><i class=\"icon-info-sign\"></i>No existe ning&uacute;n Consultor TIS registrado.</h4>
                  </div>";
          }
        ?>
			</div>
